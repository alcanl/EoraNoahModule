namespace EarTechnicNoahModule.Global
{
    public static class Resources
    {
        ...
        public const int HISelection_R = 130;
        public const int HITest_L = 5;
        public const int HITest_R = 6;
        public const string LeftEar = "Left";
        public const string RightEar = "Right";
